...
class ConverterUseCase {
    ...
    decimalToHexadecimal(decimal) {
        ...
        resultList.forEach(n => {
            for (let prop in numbersGreaterThanTen) {
                if (n == prop)
                    resultList[resultList.indexOf(n)] = numbersGreaterThanTen[prop];
            }
        });
    ...
    hexadecimalToDecimal(hexadecimal) {
        ...
        hexadecimalList.forEach(n => {
            for (let prop in numbersGreaterThanTen) {
                if (n == prop)
                    hexadecimalList[hexadecimalList.indexOf(n)] = numbersGreaterThanTen[prop];
            }
        });
...
exports.default = ConverterUseCase;
